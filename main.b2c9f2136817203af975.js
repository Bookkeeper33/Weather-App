...
;// CONCATENATED MODULE: ./src/modules/card.js
...
/* harmony default export */ const modules_card = (card);
...
/* harmony default export */ const weather = (fetchWeatherData);
...
const src_form = document.getElementById("myForm");
...
src_form.addEventListener("submit", async (e) => {
    ...
    const data = await weather(input.value);

    modules_card(data).assignWeatherData();
...
/******/ })()
;
//# sourceMappingURL=main.b2c9f2136817203af975.js.map